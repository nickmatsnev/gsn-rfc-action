...
case $3 in
    uat|UAT|Uat) URL="https://soap.servicenow-uat.company-name.com/cchm_change_task_update.do?SOAP" ;;
    prod|PROD|Prod) URL="https://soap.servicenow.company-name.com/cchm_change_task_update.do?SOAP" ;;
