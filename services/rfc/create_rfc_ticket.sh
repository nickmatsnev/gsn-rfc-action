...
case $3 in
    uat|UAT|Uat) URL="https://soap.servicenow-uat.dhl.com/cchm_change_request_create.do?SOAP" ;;
    prod|PROD|Prod) URL="https://soap.servicenow.dhl.com/cchm_change_request_create.do?SOAP" ;;
