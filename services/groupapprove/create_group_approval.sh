...
case $3 in
    uat|UAT|Uat) URL="https://soap.servicenow-uat.company-name.com/cchm_sysapproval_group_create.do?SOAP" ;;
    prod|PROD|Prod) URL="https://soap.servicenow.company-name.com/cchm_sysapproval_group_create.do?SOAP" ;;
